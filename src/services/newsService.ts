...
export const mockNews: NewsListItem[] = [
  {
    id: "1",
...
// Mock detailed news data with full content
...
export const fetchNews = async (): Promise<NewsListItem[]> => {
  // In a real app, this would be an API call
  return Promise.resolve(mockNews);
};

// Function to fetch news by ID
export const fetchNewsById = async (id: string): Promise<NewsDetail | null> => {
  // In a real app, this would be an API call
